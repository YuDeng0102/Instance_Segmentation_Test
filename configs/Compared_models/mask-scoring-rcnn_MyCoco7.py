...
test_evaluator = dict(
    ann_file='./data/MyCoco7/annotations/instances_test.json',
    backend_args=None,
    format_only=False,
    metric=[
        'bbox',
...
val_dataloader = dict(
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file='./data/MyCoco7/fold_0/annotations/instances_val.json',
    backend_args=None,
    format_only=False,
    metric=[
        'bbox',
...
work_dir = './work_dirs/mask-scoring-rcnn_MyCoco7/fold_0'
